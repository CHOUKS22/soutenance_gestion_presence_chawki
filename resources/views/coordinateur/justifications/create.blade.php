...
@section('content')
    {{-- Creation de justification --}}
    <div class="max-w-xl mx-auto py-10">
        <h1 class="text-xl font-bold mb-4">Justifier une absence</h1>

        <p class="mb-4">Étudiant : <strong>{{ $absence->etudiant->user->nom }}
                {{ $absence->etudiant->user->prenom }}</strong></p>

        <form action="{{ route('justifications.store', $absence->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded">Soumettre la
