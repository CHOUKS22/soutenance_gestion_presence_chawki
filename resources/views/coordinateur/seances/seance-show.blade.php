                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span
                                        class="font-medium">{{ $seance->anneeClasse->anneeAcademique->libelle ?? 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between">
                                ...
                                @if ($seance->statutSeance->libelle === 'Reportée')
                                    <div class="border-t pt-4 mt-4">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <span
                                                class="font-medium">{{ \Carbon\Carbon::parse($seance->date_reportee)->format('d/m/Y') ?? '-' }}</span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Heure Début :</span>
                                            <span
                                                class="font-medium">{{ \Carbon\Carbon::parse($seance->heure_debut_report)->format('H:i') ?? '-' }}</span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600">Heure Fin :</span>
                                            <span
                                                class="font-medium">{{ \Carbon\Carbon::parse($seance->heure_fin_report)->format('H:i') ?? '-' }}</span>
                                        </div>
                                        <div class="flex justify-between">
